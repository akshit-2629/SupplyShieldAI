...
# Prepend the root backend folder to system paths to allow module imports
...
def run_migrations_offline() -> None:
    ...
    SQL commands to the demo output.
...
def run_migrations_online() -> None:
    ...
    """
    # Override settings URL dynamically from environment config
